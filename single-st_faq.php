...
<?php
$st_faq_sidebar = apply_filters( 'knowhow_get_theme_option', 'st_faq_sidebar', null );
    ...
    <section id="content" role="main">
      ...
      <?php while ( have_posts() ) : the_post(); ?>
        ...
        <div class="entry-content">
          <?php the_content(); ?>
          <?php numbered_in_page_links( array( 'before' => '<div class="page-links"><strong>' . __( 'Pages:', 'knowhow' ) .'</strong>', 'after' => '</div>' ) ); ?>
        </div>
